...
public class Gui : MonoBehaviour
{
    ...
    void OnGUI()
	{
		...
		windowRect = GUI.Window(0, windowRect, DoMyWindow, "REPARING PROGRAM");
	}
	...
	void DoMyWindow(int windowID)
	{
		...
		GUI.Box(new Rect(20, 50, 120, 250), "REPAIR");
		GUI.Button(new Rect(30, 80, 100, 20), "START");
