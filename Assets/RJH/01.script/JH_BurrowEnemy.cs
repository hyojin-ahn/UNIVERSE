...
public class JH_BurrowEnemy : MonoBehaviour
{
    public enum State
    {
        Idle,//정지
    ...
    public GameObject burrowFas;
    public Transform burrowPos;
    void IdleState()
    {
        ...
        if (distance < chaseDistance)
        {
            ...
            GameObject burrow = Instantiate(burrowFas);
            burrowFas.transform.position = burrowPos.transform.position;
            ParticleSystem bs = burrow.GetComponent<ParticleSystem>();
            bs.Play();
            Destroy(burrow, 3);
